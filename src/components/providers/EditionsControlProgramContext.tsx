...
import { IDL, LibreplexEditionsControls } from '../../lib/anchor/controls/libreplex_editions_controls';
...
const EditionsControlContext = createContext<ProgramContextType | undefined>(undefined);

export function EditionsControlProgramProvider({ children }: { children: React.ReactNode }) {
    const [program, setProgram] = useState<anchor.Program<LibreplexEditionsControls> | null>(null);
