...
export function GroupMembersProvider({
    ...
    const fetchMembers = useCallback(async () => {
        ...
        try {
            ...
            const newHashlist = new Set(fetchedMembers.map(member => member.mint).filter((y): y is string => y !== undefined));
    ...
    return (
        <GroupMembersContext.Provider value={{ members, hashlist, groupId, isLoading, refreshMembers }}>
            {children}
