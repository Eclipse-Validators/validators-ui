...
import { IDL } from "../../lib/anchor/editions/libreplex_editions";
import { PROGRAM_ID_EDITIONS } from "../../lib/anchor/editions/constants";
import { LibreplexEditions } from "../../lib/anchor/editions/libreplex_editions";
...
export function EditionsProgramProvider({ children }: { children: React.ReactNode }) {
  const [program, setProgram] = useState<anchor.Program<LibreplexEditions> | null>(null);
